...
class HighlightAdapter(val highlightList: List<Highlight>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HighlightAdapter.ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.highlight_item, parent, false)
//        mediaController = MediaController(parent.context)
    ...
    override fun onBindViewHolder(holder: HighlightAdapter.ViewHolder, position: Int) {
        ...
        holder.videoView.loadData(
            "<iframe width=\"100%\" height=\"100%\" src=\"" + highlight.uri + "\" frameborder=\"0\" allowfullscreen></iframe>",
            "text/html",
            "utf-8"
        )
    }
