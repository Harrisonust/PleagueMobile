...
class GamePageSummaryFragment(val game: Game) : Fragment() {
    ...
    var gs = game.guestStats.data
    var guestTeam = getTeamById(game.guestTeam)
    var hs = game.hostStats.data
    var hostTeam = getTeamById(game.hostTeam)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val gameViewModel: GameViewModel by activityViewModels { GameViewModelFactory(game.gameId.ID) }
        gameViewModel.getGame().observe(viewLifecycleOwner, {
            Log.d("ViewMode", "get game!!!!!")
            val game = it
//            gs = game.guestStats.data
//            guestTeam = getTeamById(game.guestTeam)
//            hs = game.hostStats.data
//            hostTeam = getTeamById(game.hostTeam)
