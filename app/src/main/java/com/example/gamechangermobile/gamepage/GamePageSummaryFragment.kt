...
class GamePageSummaryFragment(val game: Game) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        guest_point_leader_point.setTextColor(resources.getColor(guestTeam.color))
        ...
        guest_rebounds_leader_point.setTextColor(resources.getColor(guestTeam.color))
        ...
        guest_assist_leader_point.setTextColor(resources.getColor(guestTeam.color))
        ...
        guest_steal_leader_point.setTextColor(resources.getColor(guestTeam.color))
        ...
        guest_block_leader_point.setTextColor(resources.getColor(guestTeam.color))

        guest_icon.setImageResource(guestTeam.profilePic)
        ...
        guest_3_pointer_bar.setBackgroundColor(resources.getColor(guestTeam.color))
        ...
        guest_free_throw_bar.setBackgroundColor(resources.getColor(guestTeam.color))

        guest_assist.text = gs["assists"]!!.toInt().toString()
        guest_assist_bar.setBackgroundColor(resources.getColor(guestTeam.color))

        guest_total_rebound.text = gs["rebounds"]!!.toInt().toString()
        guest_total_rebound_bar.setBackgroundColor(resources.getColor(guestTeam.color))

        guest_offensive_rebound.text = gs["offensiveRebounds"]!!.toInt().toString()
        guest_offensive_rebound_bar.setBackgroundColor(resources.getColor(guestTeam.color))

        guest_defensive_rebound.text = gs["defensiveRebounds"]!!.toInt().toString()
        guest_defensive_rebound_bar.setBackgroundColor(resources.getColor(guestTeam.color))

        guest_steal.text = gs["steals"]!!.toInt().toString()
        guest_steal_bar.setBackgroundColor(resources.getColor(guestTeam.color))

        guest_block.text = gs["blocks"]!!.toInt().toString()
        guest_block_bar.setBackgroundColor(resources.getColor(guestTeam.color))

        guest_turnover.text = gs["turnovers"]!!.toInt().toString()
        guest_turnover_bar.setBackgroundColor(resources.getColor(guestTeam.color))

        guest_points_off_turnovers.text = game.guestStats.data["pointsOffTurnovers"]!!.toInt().toString()
        guest_points_off_turnovers_bar.setBackgroundColor(resources.getColor(guestTeam.color))

        guest_fouls.text = gs["personalFouls"]!!.toInt().toString()
        guest_fouls_bar.setBackgroundColor(resources.getColor(guestTeam.color))

        guest_timeouts_remaining.text = game.guestStats.data["timeoutRemaining"]!!.toInt().toString()
        guest_timeouts_remaining_bar.setBackgroundColor(resources.getColor(guestTeam.color))
        ...
        host_point_leader_point.setTextColor(resources.getColor(hostTeam.color))
        ...
        host_rebounds_leader_point.setTextColor(resources.getColor(hostTeam.color))
        ...
        host_assist_leader_point.setTextColor(resources.getColor(hostTeam.color))
        ...
        host_steal_leader_point.setTextColor(resources.getColor(hostTeam.color))
        ...
        host_block_leader_point.setTextColor(resources.getColor(hostTeam.color))

        host_icon.setImageResource(hostTeam.profilePic)
        ...
        host_field_goal_bar.setBackgroundColor(resources.getColor(hostTeam.color))
        ...
        host_3_pointer_bar.setBackgroundColor(resources.getColor(hostTeam.color))
        ...
        host_free_throw_bar.setBackgroundColor(resources.getColor(hostTeam.color))

        host_assist.text = hs["assists"]!!.toInt().toString()
        host_assist_bar.setBackgroundColor(resources.getColor(hostTeam.color))

        host_total_rebound.text = hs["rebounds"]!!.toInt().toString()
        host_total_rebound_bar.setBackgroundColor(resources.getColor(hostTeam.color))

        host_offensive_rebound.text = hs["offensiveRebounds"]!!.toInt().toString()
        host_offensive_rebound_bar.setBackgroundColor(resources.getColor(hostTeam.color))

        host_defensive_rebound.text = hs["defensiveRebounds"]!!.toInt().toString()
        host_defensive_rebound_bar.setBackgroundColor(resources.getColor(hostTeam.color))

        host_steal.text = hs["steals"]!!.toInt().toString()
        host_steal_bar.setBackgroundColor(resources.getColor(hostTeam.color))

        host_block.text = hs["blocks"]!!.toInt().toString()
        host_block_bar.setBackgroundColor(resources.getColor(hostTeam.color))

        host_turnover.text = hs["turnovers"]!!.toInt().toString()
        host_turnover_bar.setBackgroundColor(resources.getColor(hostTeam.color))

        host_points_off_turnovers.text = game.hostStats.data["pointsOffTurnovers"]!!.toInt().toString()
        host_points_off_turnovers_bar.setBackgroundColor(resources.getColor(hostTeam.color))

        host_fouls.text = hs["personalFouls"]!!.toInt().toString()
        host_fouls_bar.setBackgroundColor(resources.getColor(hostTeam.color))

        host_timeouts_remaining.text = game.hostStats.data["timeoutRemaining"]!!.toInt().toString()
        host_timeouts_remaining_bar.setBackgroundColor(resources.getColor(hostTeam.color))
    ...
    private fun changeBarWidth(completeBarWidth: Float, guestBar: View, hostBar: View, guestValue: Float, hostValue: Float) {
        ...
        guestBar.setBackgroundColor(resources.getColor(getTeamById(game.guestTeam)!!.color))
        hostBar.setBackgroundColor(resources.getColor(getTeamById(game.hostTeam)!!.color))
