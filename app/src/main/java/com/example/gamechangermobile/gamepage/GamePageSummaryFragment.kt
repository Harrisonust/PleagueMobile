...
class GamePageSummaryFragment(val game: Game) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
         ...
         */
        guest_icon.setImageResource(guestTeam?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24)
        ...
        guest_point_leader_image.setImageResource(
            game.guestPointLeader?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24
        )
        ...
        guest_rebounds_leader_image.setImageResource(
            game.guestReboundLeader?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24
        )
        ...
        guest_assist_leader_image.setImageResource(
            game.guestAssistLeader?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24
        )
        ...
        guest_steal_leader_image.setImageResource(
            game.guestStealLeader?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24
        )
        ...
        guest_block_leader_image.setImageResource(
            game.guestBlockLeader?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24
        )
         ...
         */
        host_icon.setImageResource(hostTeam?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24)
        ...
        host_point_leader_image.setImageResource(
            game.hostPointLeader?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24
        )
        ...
        host_rebounds_leader_image.setImageResource(
            game.hostReboundLeader?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24
        )
        ...
        host_assist_leader_image.setImageResource(
            game.hostAssistLeader?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24
        )
        ...
        host_steal_leader_image.setImageResource(
            game.hostStealLeader?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24
        )
        ...
        host_block_leader_image.setImageResource(
            game.hostBlockLeader?.profilePic ?: R.drawable.ic_baseline_sports_basketball_24
        )
        game.hostBlockLeader?.fullName?.let {
            host_block_leader_name.text = it
        }
        game.hostBlockLeader?.let {
            game.getPlayerStats(it)?.data?.get("blocks")?.let {
                host_block_leader_point.text = it.toInt().toString()
            }
        }
        ...
        guest_field_goal.text =
            gs["fieldGoal"]!!.toInt().toString() + "/" + gs["fieldGoalAttempt"]!!.toInt()
                .toString() + "(" + gs["fieldGoalPercentage"]!!.toString() + "%)"
        ...
        guest_3_pointer.text =
            gs["fieldGoal3pt"]!!.toInt().toString() + "/" + gs["fieldGoalAttempt3pt"]!!.toInt()
                .toString() + "(" + gs["fieldGoalPercentage3pt"]!!.toString() + "%)"
        ...
        guest_free_throw.text =
            gs["freeThrow"]!!.toInt().toString() + "/" + gs["freeThrowAttempt"]!!.toInt()
                .toString() + "(" + gs["freeThrowAttemptPercentage"]!!.toString() + "%)"
        ...
        host_field_goal.text =
            hs["fieldGoal"]!!.toInt().toString() + "/" + hs["fieldGoalAttempt"]!!.toInt()
                .toString() + "(" + hs["fieldGoalPercentage"]!!.toString() + "%)"
        host_field_goal_bar.setBackgroundColor(resources.getColor(hostTeam?.color ?: R.color.black))

        host_3_pointer.text =
            hs["fieldGoal3pt"]!!.toInt().toString() + "/" + hs["fieldGoalAttempt3pt"]!!.toInt()
                .toString() + "(" + hs["fieldGoalPercentage3pt"]!!.toString() + "%)"
        host_3_pointer_bar.setBackgroundColor(resources.getColor(hostTeam?.color ?: R.color.black))

        host_free_throw.text =
            hs["freeThrow"]!!.toInt().toString() + "/" + hs["freeThrowAttempt"]!!.toInt()
                .toString() + "(" + hs["freeThrowAttemptPercentage"]!!.toString() + "%)"
...
//         set bar width
    ...
    private fun changeBarWidth(
        ...
        if (guestValue == null || hostValue == null || (guestValue == hostValue && hostValue.toInt() == 0)) {
            guestBar.layoutParams.width = 0
            hostBar.layoutParams.width = 0
            //TODO if both value is 0 then do other stuff this seems not working
        } else {
